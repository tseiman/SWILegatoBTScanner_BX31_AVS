...
#ifndef GPIO_BX_ENABLE_INTERFACE_H_INCLUDE_GUARD
#define GPIO_BX_ENABLE_INTERFACE_H_INCLUDE_GUARD
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*gpio_bx_enable_DisconnectHandler_t)(void *);
 ...
 */
//--------------------------------------------------------------------------------------------------
void gpio_bx_enable_ConnectService
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t gpio_bx_enable_TryConnectService
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
void gpio_bx_enable_SetServerDisconnectHandler
(
    gpio_bx_enable_DisconnectHandler_t disconnectHandler,
    void *contextPtr
);
 ...
 */
//--------------------------------------------------------------------------------------------------
void gpio_bx_enable_DisconnectService
(
    void
);
...
typedef enum
{
    GPIO_BX_ENABLE_ACTIVE_HIGH = 0,
        ///< GPIO active-high, output is 1
    GPIO_BX_ENABLE_ACTIVE_LOW = 1
        ///< GPIO active-low, output is 0
}
gpio_bx_enable_Polarity_t;
...
typedef enum
{
    GPIO_BX_ENABLE_EDGE_NONE = 0,
        ///< No edge detection
    GPIO_BX_ENABLE_EDGE_RISING = 1,
        ///< Notify when voltage goes from low to high.
    GPIO_BX_ENABLE_EDGE_FALLING = 2,
        ///< Notify when voltage goes from high to low.
    GPIO_BX_ENABLE_EDGE_BOTH = 3
        ///< Notify when pin voltage changes state in either direction.
}
gpio_bx_enable_Edge_t;


//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'gpio_bx_enable_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
typedef struct gpio_bx_enable_ChangeEventHandler* gpio_bx_enable_ChangeEventHandlerRef_t;
...
typedef enum
{
    GPIO_BX_ENABLE_PULL_OFF = 0,
        ///< Neither resistor is enabled
    GPIO_BX_ENABLE_PULL_DOWN = 1,
        ///< Pulldown resistor is enabled
    GPIO_BX_ENABLE_PULL_UP = 2
        ///< Pullup resistor is enabled
}
gpio_bx_enable_PullUpDown_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*gpio_bx_enable_ChangeCallbackFunc_t)
(
    bool state,
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t gpio_bx_enable_SetInput
(
    gpio_bx_enable_Polarity_t polarity
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t gpio_bx_enable_SetPushPullOutput
(
    gpio_bx_enable_Polarity_t polarity,
        ///< [IN] Active-high or active-low.
    bool value
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t gpio_bx_enable_SetTriStateOutput
(
    gpio_bx_enable_Polarity_t polarity
        ///< [IN] Active-high or active-low.
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t gpio_bx_enable_SetOpenDrainOutput
(
    gpio_bx_enable_Polarity_t polarity,
        ///< [IN] Active-high or active-low.
    bool value
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t gpio_bx_enable_EnablePullUp
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t gpio_bx_enable_EnablePullDown
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t gpio_bx_enable_DisableResistors
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t gpio_bx_enable_Activate
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t gpio_bx_enable_Deactivate
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t gpio_bx_enable_SetHighZ
(
    void
);
...
//--------------------------------------------------------------------------------------------------
/**
 * Add handler function for EVENT 'gpio_bx_enable_ChangeEvent'
 *
 ...
 */
//--------------------------------------------------------------------------------------------------
gpio_bx_enable_ChangeEventHandlerRef_t gpio_bx_enable_AddChangeEventHandler
(
    gpio_bx_enable_Edge_t trigger,
        ///< [IN] Change(s) that should trigger the callback to be called.
    gpio_bx_enable_ChangeCallbackFunc_t handlerPtr,
...
//--------------------------------------------------------------------------------------------------
/**
 * Remove handler function for EVENT 'gpio_bx_enable_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
void gpio_bx_enable_RemoveChangeEventHandler
(
    gpio_bx_enable_ChangeEventHandlerRef_t handlerRef
        ///< [IN]
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t gpio_bx_enable_SetEdgeSense
(
    gpio_bx_enable_Edge_t trigger
        ///< [IN] Change(s) that should trigger the callback to be called.
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t gpio_bx_enable_DisableEdgeSense
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
gpio_bx_enable_Edge_t gpio_bx_enable_GetEdgeSense
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
gpio_bx_enable_Polarity_t gpio_bx_enable_GetPolarity
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
gpio_bx_enable_PullUpDown_t gpio_bx_enable_GetPullUpDown
(
    void
);

#endif // GPIO_BX_ENABLE_INTERFACE_H_INCLUDE_GUARD